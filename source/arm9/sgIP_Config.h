...
#    define SGIP_INTR_PROTECT()   int tIME = enterCriticalSection()
#    define SGIP_INTR_REPROTECT() tIME = enterCriticalSection()
#    define SGIP_INTR_UNPROTECT() leaveCriticalSection(tIME)
#    define SGIP_WAITEVENT()      sgIP_IntrWaitEvent()
