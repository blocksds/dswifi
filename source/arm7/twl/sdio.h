...
#ifndef DSWIFI_ARM7_TWL_SDIO_H__
#define DSWIFI_ARM7_TWL_SDIO_H__
...
// Bit 0 determines if SD is protected or not?
#define WIFI_SDIO_OFFS_PROTECTED       (0x0F6)
...
#define WIFI_SDIO_MASK_ERR     (WIFI_SDIO_STAT1_ILL_ACCESS | WIFI_SDIO_STAT1_CMDTIMEOUT | \
                                WIFI_SDIO_STAT1_TXUNDERRUN | WIFI_SDIO_STAT1_RXOVERFLOW | \
                                WIFI_SDIO_STAT1_DATATIMEOUT | WIFI_SDIO_STAT1_STOPBIT_ERR | \
                                WIFI_SDIO_STAT1_CRCFAIL | WIFI_SDIO_STAT1_CMD_IDX_ERR)
