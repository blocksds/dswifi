...
#define SPINLOCK_OWNER_NOBODY 0x0000
#define SPINLOCK_OWNER_ARM7   0x0001
#define SPINLOCK_OWNER_ARM9   0x0002
...
#ifdef ARM7
#    define SPINLOCK_VALUE SPINLOCK_OWNER_ARM7
#endif
#ifdef ARM9
#    define SPINLOCK_VALUE SPINLOCK_OWNER_ARM9
#endif
